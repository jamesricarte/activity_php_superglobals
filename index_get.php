...
<body>
    ...
    <?php
    if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_REQUEST["fname"]) && $_REQUEST["fname"] != "" && isset($_REQUEST["lname"]) && $_REQUEST["lname"] != "" && isset($_REQUEST["mname"]) && $_REQUEST["mname"] != "" && isset($_REQUEST["age"]) && $_REQUEST["age"] != "" && isset($_REQUEST["course"]) && $_REQUEST["course"] != "" && isset($_REQUEST["year"]) && $_REQUEST["year"] != "" && isset($_REQUEST["enrolled"]) && isset($_REQUEST["subject"])  && $_REQUEST["subject"] != "") {
